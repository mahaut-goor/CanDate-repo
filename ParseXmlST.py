...
def parse_xml_tip_dates(
    ...
    new_tip_id = "_".join(new_sample_id.split("_")[:-1])
...
if __name__ == "__main__":
    ...
    input_xml = r"/dss/dsshome1/09/re98gan/ANALYSIS/tip_dating/TD_ANALYSIS/DOG_DBB_D_Pinarbasi2_15837_final_trimmed.xml"
